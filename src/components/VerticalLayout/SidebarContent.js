        ...
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu" >
                <li>
                  <Link to={linkTo("/email-inbox")}>{props.t("Inbox")}</Link>
                </li>
                <li>
                  <Link to={linkTo("/email-read")}>{props.t("Email Read")} </Link>
                </li>
                <li>
                  <Link to={linkTo("/email-compose")}>{props.t("Email Compose")} </Link>
                </li>
              </ul>
            </li>

            <li>
              <Link to={linkTo("/chat")} className=" waves-effect">
            ...
            <li>
              <Link to={linkTo("/kanbanboard")} className=" waves-effect">
