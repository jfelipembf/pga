...
import { useClientEnrollments } from '../ClientEnrollmentTab/hooks/useClientEnrollments'
import { formatCurrency } from '../../../../utils/format'
import StatusBadge from '../../../../components/Common/StatusBadge'
import ClientAttendanceMetrics from './components/ClientAttendanceMetrics'
                                            ...
                                            {activeContracts.map((contract) => (
                                                <tr key={contract.id}>
                                                    <td>
                                                        ...
                                                        <span className="text-muted font-size-11">{contract.idClientContract}</span>
                                                    </td>
                                                    <td>
