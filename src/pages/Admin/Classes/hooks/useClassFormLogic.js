...
import { buildClassPayload } from "../../../../utils/payloadBuilders"
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            await withLoading("delete", async () => {
                const effectiveDate = formState.effectiveDate ? new Date(formState.effectiveDate + 'T12:00:00') : null
                await deleteClass(formState.id, { effectiveDate })
        ...
        try {
            await withLoading("save", async () => {
                ...
                if (formState.id) {
                    ...
                    const effectiveDate = rawPayload.effectiveDate ? new Date(rawPayload.effectiveDate + 'T12:00:00') : null

                    await updateClass(formState.id, payload, { effectiveDate })
