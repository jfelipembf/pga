...
const EventsPage = ({ setBreadcrumbItems }) => {
    ...
    useEffect(() => {
        ...
        setBreadcrumbItems("Ciclos de Avaliação e Testes", breadcrumbItems)
    }, [setBreadcrumbItems])
        ...
        <div>
            {loading && events.length === 0 ? (
                <div className="text-center p-4">
                    <i className="mdi mdi-loading mdi-spin font-size-24 text-primary"></i>
                    <p className="mt-2 text-muted small">Carregando ciclos...</p>
                </div>
            ) : events.length === 0 ? (
