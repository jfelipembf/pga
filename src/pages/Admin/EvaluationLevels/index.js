...
const EvaluationLevelsPage = ({ setBreadcrumbItems }) => {
    ...
    const MainContent = (
        <div className="position-relative" style={{ minHeight: '400px' }}>
            <OverlayLoader show={saving} label="Salvando nível..." />
            <OverlayLoader show={deleting} label="Excluindo nível..." />
            ...
            {(selectedId || isAddingNew) && formData ? (
                ...
                <div className="d-flex flex-column align-items-center justify-content-center h-100 text-muted">
                    <i className="mdi mdi-chart-line mb-3" style={{ fontSize: '5rem', opacity: 0.1 }}></i>
    ...
    return (
        <React.Fragment>
            <ManagementLayout
                sidebarTitle="Níveis de Avaliação"
                addLabel="Novo Nível"
