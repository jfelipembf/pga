...
export const INTENSITIES = [
    { value: "A1", label: "A1 (Leve)" },
    { value: "A2", label: "A2 (Moderado)" },
    { value: "A3", label: "A3 (Forte)" },
    { value: "AN", label: "AN (Anaeróbio)" },
    { value: "VEL", label: "Velocidade" },
];
...
export const DISTANCE_OPTIONS = [
    25, 50, 75, 100, 150, 200, 300, 400, 500, 800, 1000, 1500
];
