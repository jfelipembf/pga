...
// Mock store actions as they are missing in current project
const onGetTasks = () => ({ type: "MOCK_GET_TASKS" })
const onAddCardData = () => ({ type: "MOCK_ADD_TASK" })
const onUpdateCardData = () => ({ type: "MOCK_UPDATE_TASK" })
const OnDeleteKanban = () => ({ type: "MOCK_DELETE_TASK" })

const AddTeamMember = [
  { id: 1, name: "Membro 1", img: "https://via.placeholder.com/150" },
  { id: 2, name: "Membro 2", img: "https://via.placeholder.com/150" },
]
...
const TestDashboard = (props) => {
  ...
  // Mocked state since store/tasks is missing
  const kanbanTasks = React.useMemo(() => [
    { id: '1', name: 'To Do', cards: [{ id: 'c1', title: 'Tarefa Teste 1', date: '14 Feb, 2026', badgeText: 'Waiting', budget: '100', userImages: [] }] },
    { id: '2', name: 'In Progress', cards: [] },
    { id: '3', name: 'Completed', cards: [] }
  ], [])
  const loading = false
        ...
        isLoading ? <Spinners setLoading={setLoading} /> :
          <div className="task-board">
            <DragDropContext onDragEnd={handleDragEnd}>
              {(cards || []).map(line => (
                <div className="task-list" key={line.id}>
                  <Card>
                    <CardBody>
                      ...
                      <Droppable droppableId={line.id}>
                        {provided => (
                          ...
                          >
                            <SimpleBar className="tasklist-content">
...
export default connect(null, { setBreadcrumbItems })(TestDashboard)
