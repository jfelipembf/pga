...
const Recoverpw = (props) => {
  ...
  document.title = "Recover Password | PGA Gestão de Piscinas";
  return (
    <React.Fragment>
          ...
          <Row className="justify-content-center">
            <Col md={8} lg={6} xl={5}>
              ...
              <div className="mt-5 text-center">
                ...
                <p>
                  © {new Date().getFullYear()} PGA Gestão de Piscinas <span className="d-none d-sm-inline-block"> - Crafted with <i className="mdi mdi-heart text-danger"></i> by PGA.</span>
                </p>
              </div>
            </Col>
          </Row>
