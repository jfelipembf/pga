...
// import images
import logoLightPng from "../../assets/images/pgaLogo.png"
          ...
          <Row className="justify-content-center">
            <Col md={8} lg={6} xl={5}>
              <Card className="overflow-hidden">
                <CardBody className="pt-0">
                  ...
                  <div className="p-3">
                    ...
                    <p className="text-muted text-center">Sign in to continue to PGA Gestão de Piscinas.</p>
                    <Form
              ...
              <div className="mt-5 text-center">
                ...
                <p>
                  © {new Date().getFullYear()} PGA Gestão de Piscinas
                  <span className="d-none d-sm-inline-block"> - Crafted with <i className="mdi mdi-heart text-danger"></i> by PGA.</span>
                </p>
              </div>
            </Col>
          </Row>
